...
//  1. Color settings
//   a. layout colors
    var layoutColor = '#2980b9'; //overlay color
    var textColor = '#fff'; //text paragraphs color, menu color, form borders color

//   b. footer colors
    var footerColor = '#fff'; //color of footer background
    var linksColor = '#2980b9'; //social links color, youtube controls color, contact top menu color
    var copyrightsColor = '#2f2f2f'; //copyrights color



//  2. Background
//    a. background type
    var backgroundType = 'color'; //image - single image, gallery - image for each slide, video - youtube video background, color - for no background, just color (including contact page)
...
//  3. Overlay
//   a. overlay type
    var overlayType = 'none'; //none, color, image, gradient, colorAndImage
...
//   b. overlay settings
    ...
    var overlayGradient = '45, #4fc1e9, 1, #1abc9c, 1'; //gradient format: 'degree, color-1, opacity-1, color-2, opacity-2'
//   b. overlay opacity
    var opacity = 0.9; // 0 -transparent, 1 - non-transparent



//  4. Animations
//   a. subtitle animation
    var subtitleAnimation = 'bounceInRight'; //animation of subtitle revealing, full list: http://daneden.github.io/animate.css/
...
//  5. Homepage widget
//   a. widget type
    var widget = 'twitter'; //possible choices: quote, twitter, text, countdown
...
//   d. countdown settings
    var endDate = 'June 16, 2016 20:39:00'; //set desired end date, example: 'June 26, 2015 20:39:00'
...
//  7. Google maps
//   a. display control
    var displayMap = false; //true - display google maps, false - display custom image
...
//   g. styles
    var mapStyles = [{"stylers":[{"visibility":"off"}]},
            {"featureType":"water","stylers":[{"visibility":"on"},{"color":seaColor}]},
            {"featureType":"landscape","stylers":[{"visibility":"on"},{"color":landColor}]},
            {"featureType":"administrative","elementType":"geometry.stroke","stylers":[{"visibility":borderVisibility},{"color":borderColor},{"weight":border}]}];